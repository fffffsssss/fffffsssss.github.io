...
My previous research focused on developing tools for single-molecule localization microscopy (SMLM), especially **AI4SMLM**. I developed a series of physics-informed deep learning methods to enhance the robustness of SMLM under complex imaging conditions. I’m also interested in **Intelligent Optical Systems** and **Computer Vision**, where I want to combine physics (from both theory and hardware) with the power of AI to build tools that really advance the field. I’m always looking for opportunities to participate in projects that don't just sound cool, but are truly useful for researchers and engineers.
